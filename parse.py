...
def parse_all():
    ...
    parser.add_argument("x", type=float, help="abscissa of the original point")
    parser.add_argument("y", type=float, help="ordinate of the original point")
